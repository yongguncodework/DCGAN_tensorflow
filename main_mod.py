...
flags.DEFINE_float("beta1", 0.41, "Momentum term of adam [0.5]")
...
def main(_):
  ...
  FLAGS.dataset = "goodimagetrain"
  FLAGS.input_height = 64
  FLAGS.train = True
  FLAGS.crop = True
  ...
  with tf.Session(config=run_config) as sess:
    ...
    #                 [dcgan.h1_w, dcgan.h1_bcentralized target, dcgan.g_bn1],
